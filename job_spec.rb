  ...
  describe Sorter do
    describe 'execute' do
      ...
      it 'raises an error if a job depends on himself' do
        jobs_string = 'a => \nb => \nc => c\n'
        expect{ Sorter.new.execute jobs_string }.to raise_error
      end
